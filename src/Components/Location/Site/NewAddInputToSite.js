...
const NewAddInputToSite = (mydata) => {
  ...
  useEffect(() => {
    ...
    axios({
      ...
      url: `/getmappedinputs/deviceid_tagid?tagid=${currentSelectedTag}&subsiteid=${mydata.mydata.key}`,
    })
      .then((res) => {
...
export default NewAddInputToSite;
